...
I could've used `scipy.stats.norm`, but to keep zero external deps I implemented
the Abramowitz & Stegun 26.2.17 approximation myself — accuracy ~1e-7, plenty
for pricing. Time T is in years; rates/vols are annualized.
"""
...
def _norm_cdf(x: float) -> float:
    ...
    # skipping scipy keeps this dependency-free; checked vs scipy, error < 1e-7
